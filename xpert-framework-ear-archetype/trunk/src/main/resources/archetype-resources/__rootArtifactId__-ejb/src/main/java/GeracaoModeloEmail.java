...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        salvarModeloEmail("[${parentArtifactId}] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[${parentArtifactId}] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
