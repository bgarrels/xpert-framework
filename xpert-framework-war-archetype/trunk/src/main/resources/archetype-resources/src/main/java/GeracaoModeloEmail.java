...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        salvarModeloEmail("[${artifactId}] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[${artifactId}] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
